...
+ Capitalize vs Expensing
    ...
    + Expense short term benefits <1 year
...
||Ownership|Treatment|
|--|--|--|
|Equity Method|< 50%|**IS:** ownership% * sub income **CFS:** reverse line, add ownership% * sub dividend **BS:** creates and asset that increases by equity investment earnings, and decreases by dividends|
|Consolidation| >50%||
|Security|small %||
